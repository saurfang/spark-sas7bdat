...
class SasRelationSpec extends FlatSpec with Matchers with SharedSparkContext {
  ...
  "SASReltion" should "read internally compressed SAS data exactly correct" in {
  ...
  "SASReltion" should "read SAS files with formatted numeric columns as decimals/longs if inferDecimal and inferLong are enabled" in {
